        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="text-end mb-3">
                    <a href="index.php?p=struktur&aksi=input" class="btn btn-primary mb-1">tambah struktur
                    </a>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td width="15%" class="text-centered">
                                            <a href="index.php?p=struktur&aksi=edit&id_edit=<?php echo $data['id']?>" class="btn btn-warning">Edit</a>   
                                            <a href="proses_struktur.php?proses=delete&id_hapus=<?php echo $data['id']?>" class="btn btn-danger" onclick="return confirm('Yakin akan menghapus data?')">Hapus</a>   
                                        </td>
                                    </tr>
